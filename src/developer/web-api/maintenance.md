...
### Delete single min-max data element { #webapi_delete_min_max_data_element } 
...
### Add/update multiple min-max data elements { #webapi_add_update_multiple_min_max_data_elements }
