...
|`potentialDuplicate`|`Boolean`|`true`&#124;`false`| Filter the result based on the fact that a tei is a Potential Duplicate. If omitted, we don't check whether a tei is a potentialDuplicate or not. |
