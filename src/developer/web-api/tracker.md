...
| order | To specify ordering/sorting of fields and its directions in comma separated values. A single item in order is of the form "orderDimension:direction". Note: Supported are created, createdAt, inactive and the tracked entity attributes | "order"="a3kGcGDCuk6:desc" |
