...
| potentialDuplicate | Filter the result based on the fact that a tei is a Potential Duplicate. Can be true &#124; false or omitted. If omitted, we don't check whether a tei is a potentialDuplicate or not. |
