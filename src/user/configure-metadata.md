...
11. In the **Value type** field, select the type of data that the data
    ...
    |---|---|
    | Age | Dates renderes as calendar widget OR by entering number of years, months and/or days which calculates the date value based on current date. The date will be saved in the backend. |
