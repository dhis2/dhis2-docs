...
5.  Click **Define program rule actions** and create the actions
    ...
    1.  Click the add button, select an **Action** and enter the
        ...
        | **Prevent adding new events to stage** | **Program stage where new events should be prevented** | Used when you want to prevent new events to be added to a program stage. Existing events will not be hidden.
