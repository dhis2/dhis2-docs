...
| AI    | Data Title                      | Description                                                                                                                                | Format       | Fixed Length |
|-------|---------------------------|--------------------------------------------------------------------------------------------------------------------------------------------|--------------|--------------|
|  00   | SSCC                      | SSCC (Serial Shipping Container Code)                                                                                                      | N2+N18       | 20           |
|  01   | GTIN                      | Global Trade Item Number                                                                                                                   | N2+N14       | 16           |
|  02   | CONTENT                   | GTIN of Trade Items Contained in a logistic unit                                                                                           | N2+N14       | 16           |
|  10   | LOT_NUMBER                | Batch or lot number                                                                                                                        | N2+X..20     | Variable     |
|  11   | PROD_DATE                 | Production date (YYMMDD)                                                                                                                   | N2+N6        | 8            |
|  12   | DUE_DATE                  | Due date (YYMMDD)                                                                                                                          | N2+N6        | 8            |
|  13   | PACK_DATE                 | Packaging date (YYMMDD)                                                                                                                    | N2+N6        | 8            |
|  15   | BEST_BEFORE_DATE          | Best before date (YYMMDD)                                                                                                                  | N2+N6        | 8            |
|  16   | SELL_BY                   | Sell by date (YYMMDD)                                                                                                                      | N2+N6        | 8            |
|  17   | EXP_DATE                  | Expiration date (YYMMDD)                                                                                                                   | N2+N6        | 8            |
|  20   | VARIANT                   | Internal Product variant                                                                                                                   | N2+N2        | 4            |
|  21   | SERIAL_NUMBER             | Serial number                                                                                                                              | N2+X..20     | Variable     |
|  22   | CPV                       | Consumer product variant                                                                                                                   | N2+X..20     | Variable     |
|  235  | TPX                       | Third Party Controlled, Serialised Extension of Global Trade Item Number (GTIN) (TPX)                                                      | N3+X..28     | Variable     |
|  240  | ADDITIONAL_ID             | Additional product identification assigned by the manufacturer                                                                             | N3+X..30     | Variable     |
|  241  | CUSTOMER_PART_NUMBER      | Customer part number                                                                                                                       | N3+X..30     | Variable     |
|  242  | MTO_VARIANT_NUMBER        | Made-to-Order Variation Number                                                                                                             | N3+N..6      | Variable     |
|  243  | PCN                       | Packaging component number                                                                                                                 | N3+X..20     | Variable     |
|  250  | SECONDARY_SERIAL          | Secondary serial number                                                                                                                    | N3+X..30     | Variable     |
|  251  | REF_TO_SOURCE             | Reference to source entity                                                                                                                 | N3+X..30     | Variable     |
|  253  | GDTI                      | Global Document Type Identifier                                                                                                            | N3+N13+X..17 | Variable     |
|  254  | GLN_EXTENSION_COMPONENT   | GLN Extension component                                                                                                                    | N3+X..20     | Variable     |
|  255  | GCN                       | Global Coupon Number (GCN)                                                                                                                 | N3+N13+N..12 | Variable     |
|  30   | VAR_COUNT                 | Variable count                                                                                                                             | N2+N..8      | Variable     |
|  310* | NET_WEIGHT_KG             | Net weight, kilograms (variable measure trade item                                                                                         | N4+N6        | Variable     |
|  311* | LENGTH_M                  | Length or first dimension, metres (variable measure trade item)                                                                            | N4+N6        | Variable     |
|  312* | WIDTH_M                   | Width, diameter, or second dimension, metres (variable measure trade item)                                                                 | N4+N6        | Variable     |
|  313* | HEIGHT_M                  | Depth, thickness, height, or third dimension, metres (variable measure trade item)                                                         | N4+N6        | Variable     |
|  314* | AREA_M2                   | Area, square metres (variable measure  trade item)                                                                                         | N4+N6        | Variable     |
|  315* | NET_VOLUME_L              | Net volume, litres (variable measure trade item)                                                                                           | N4+N6        | Variable     |
|  316* | NET_VOLUME_M3             | Net volume, cubic metres (variable measure trade item)                                                                                     | N4+N6        | Variable     |
|  320* | NET_WEIGHT_LB             | Net weight, pounds (variable measure trade item)                                                                                           | N4+N6        | Variable     |
|  321* | LENGTH_I                  | Length or first dimension, inches (variable measure trade item)                                                                            | N4+N6        | Variable     |
|  322* | LENGTH_F                  | Length or first dimension, feet (variable measure trade item)                                                                              | N4+N6        | Variable     |
|  323* | LENGTH_Y                  | Length or first dimension, yards (variable measure trade item)                                                                             | N4+N6        | Variable     |
|  324* | WIDTH_I                   | Width, diameter, or second dimension, inches (variable measure trade item)                                                                 | N4+N6        | Variable     |
|  325* | WIDTH_F                   | Width, diameter, or second dimension, feet (variable measure trade item)                                                                   | N4+N6        | Variable     |
|  326* | WIDTH_Y                   | Width, diameter, or second dimension, yards(variable measure trade item)                                                                   | N4+N6        | Variable     |
|  327* | HEIGHT_I                  | Depth, thickness, height, or third dimension, inches (variable measure trade item)                                                         | N4+N6        | Variable     |
|  328* | HEIGHT_F                  | Depth, thickness, height, or third dimension, feet (variable measure trade item)                                                           | N4+N6        | Variable     |
|  329* | HEIGHT_Y                  | Depth, thickness, height, or third dimension, yards (variable measure trade item)                                                          | N4+N6        | Variable     |
|  330* | GROSS_WEIGHT_GF           | Logistic weight, kilograms                                                                                                                 | N4+N6        | Variable     |
|  331* | LENGTH_M_LOG              | Length or first dimension, metres                                                                                                          | N4+N6        | Variable     |
|  332* | WIDTH_M_LOG               | Width, diameter, or second dimension, metres                                                                                               | N4+N6        | Variable     |
|  333* | HEIGHT_M_LOG              | Depth, thickness, height, or third dimension, metres                                                                                       | N4+N6        | Variable     |
|  334* | AREA_M2_LOG               | Area, square metres                                                                                                                        | N4+N6        | Variable     |
|  335* | VOLUME_L_LOG              | Logistic volume, litres                                                                                                                    | N4+N6        | Variable     |
|  336* | VOLUME_M3_LOG             | Logistic volume, cubic metres                                                                                                              | N4+N6        | Variable     |
|  337* | KG_PER_M2                 | Kilograms per square metre                                                                                                                 | N4+N6        | Variable     |
|  340* | GROSS_WHEIGHT_LB          | Logistic weight, pounds                                                                                                                    | N4+N6        | Variable     |
|  341* | LENGTH_I_LOG              | Length or first dimension, inches                                                                                                          | N4+N6        | Variable     |
|  342* | LENGTH_F_LOG              | Length or first dimension, feet                                                                                                            | N4+N6        | Variable     |
|  343* | LENGTH_Y_LOG              | Length or first dimension, yards                                                                                                           | N4+N6        | Variable     |
|  344* | WIDTH_I_LOG               | Width, diameter, or second dimension, inches                                                                                               | N4+N6        | Variable     |
|  345* | WIDTH_F_LOG               | Width, diameter, or second dimension, feet                                                                                                 | N4+N6        | Variable     |
|  346* | WIDTH_Y_LOG               | Width, diameter, or second dimension, yards                                                                                                | N4+N6        | Variable     |
|  347* | HEIGHT_I_LOG              | Depth, thickness, height, or third dimension, inches                                                                                       | N4+N6        | Variable     |
|  348* | HEIGHT_F_LOG              | Depth, thickness, height, or third dimension, feet                                                                                         | N4+N6        | Variable     |
|  349* | HEIGHT_Y_LOG              | Depth, thickness, height, or third dimension, yards                                                                                        | N4+N6        | Variable     |
|  350* | AREA_I2                   | Area, square inches (variable measure trade item)                                                                                          | N4+N6        | Variable     |
|  351* | AREA_F2                   | Area, square feet (variable measure trade item)                                                                                            | N4+N6        | Variable     |
|  352* | AREA_Y2                   | Area, square yards (variable measure trade item)                                                                                           | N4+N6        | Variable     |
|  353* | AREA_I2_LOG               | Area, square inches                                                                                                                        | N4+N6        | Variable     |
|  354* | AREA_F2_LOG               | Area, square feet                                                                                                                          | N4+N6        | Variable     |
|  355* | AREA_Y2_LOG               | Area, square yards                                                                                                                         | N4+N6        | Variable     |
|  356* | NET_WEIGHT_T              | Net weight, troy ounces (variable measure trade item)                                                                                      | N4+N6        | Variable     |
|  357* | NET_VOLUME_OZ             | Net weight (or volume), ounces (variable measure trade item)                                                                               | N4+N6        | Variable     |
|  360* | NET_VOLUME_Q              | Net volume, quarts (variable measure trade item)                                                                                           | N4+N6        | Variable     |
|  361* | NET_VOLUME_G              | Net volume, gallons U.S. (variable measure trade item)                                                                                     | N4+N6        | Variable     |
|  362* | VOLUME_Q_LOG              | Logistic volume, quarts                                                                                                                    | N4+N6        | Variable     |
|  363* | VOLUME_G_LOG              | Logistic volume, gallons U.S.                                                                                                              | N4+N6        | Variable     |
|  364* | VOLUME_I3                 | Net volume, cubic inches (variable measure trade item)                                                                                     | N4+N6        | Variable     |
|  365* | VOLUME_F3                 | Net volume, cubic feet (variable measure trade item)                                                                                       | N4+N6        | Variable     |
|  366* | VOLUME_Y3                 | Net volume, cubic yards (variable measure trade item)                                                                                      | N4+N6        | Variable     |
|  367* | VOLUME_I3_LOG             | Logistic volume, cubic inches                                                                                                              | N4+N6        | Variable     |
|  368* | VOLUME_F3_LOG             | Logistic volume, cubic feet                                                                                                                | N4+N6        | Variable     |
|  369* | VOLUME_Y3_LOG             | Logistic volume, cubic yards                                                                                                               | N4+N6        | Variable     |
|  37   | COUNT                     | Count of trade items or trade item pieces contained in a logistic unit                                                                     | N2+N..8      | Variable     |
|  390* | AMOUNT                    | Applicable amount payable or Coupon value, local currency                                                                                  | N4+N..15     | Variable     |
|  391* | AMOUNT_ISO                | Applicable amount payable with ISO currency code                                                                                           | N4+N3+N..15  | Variable     |
|  392* | PRICE                     | Applicable amount payable, single monetary area (variable measure trade item)                                                              | N4+N..15     | Variable     |
|  393* | PRICE_ISO                 | Applicable amount payable with ISO currency code (variable measure trade item)                                                             | N4+N3+N..15  | Variable     |
|  394* | PRCNT_OFF                 | Percentage discount of a coupon                                                                                                            | N4+N4        | Variable     |
|  395* | PRICE_UOM                 | Amount Payable per unit of measure single monetary area (variable measure trade item)                                                      | N4+N6        | Variable     |
|  400  | ORDER_NUMBER              | Customers purchase order number                                                                                                            | N3+X..30     | Variable     |
|  401  | GINC                      | Global Identification Number for Consignment (GINC)                                                                                        | N3+X..30     | Variable     |
|  403  | ROUTE                     | Routing code                                                                                                                               | N3+X..30     | Variable     |
|  410  | SHIP_TO_GLOB_LOC          | Ship to / Deliver to Global Location Number (GLN)                                                                                          | N3+N13       | Variable     |
|  411  | BILL_TO_LOC               | Bill to / Invoice to Global Location Number (GLN)                                                                                          | N3+N13       | Variable     |
|  412  | PURCHASED_FROM            | Purchased from Global Location Number (GLN)                                                                                                | N3+N13       | Variable     |
|  413  | SHIP_FOR_LOG              | Ship for / Deliver for - Forward to Global Location Number (GLN)                                                                           | N3+N13       | Variable     |
|  414  | LOC_NUMBER                | Identification of a physical location - Global Location Number (GLN)                                                                       | N3+N13       | Variable     |
|  415  | PAY_TO                    | Global Location Number (GLN) of the invoicing party                                                                                        | N3+N13       | Variable     |
|  416  | PROD_SERV_LOC             | Global Location Number (GLN) of the production or service location                                                                         | N3+N13       | Variable     |
|  417  | PARTY                     | Party Global Location Number (GLN)                                                                                                         | N3+N13       | Variable     |
|  420  | SHIP_TO_POST              | Ship to / Deliver to postal code within a single postal authority                                                                          | N3+X..20     | Variable     |
|  421  | SHIP_TO_POST_ISO          | Ship to / Deliver to postal code with ISO country code                                                                                     | N3+N3+X..9   | Variable     |
|  422  | ORIGIN                    | Country of origin of a trade item                                                                                                          | N3+N3        | Variable     |
|  423  | COUNTRY_INITIAL_PROCESS   | Country of initial processing                                                                                                              | N3+N3+N..12  | Variable     |
|  424  | COUNTRY_PROCESS           | Country of processing                                                                                                                      | N3+N3        | Variable     |
|  425  | COUNTRY_DISASSEMBLY       | Country of disassembly                                                                                                                     | N3+N3+N..12  | Variable     |
|  426  | COUNTRY_FULL_PROCESS      | Country covering full process chain                                                                                                        | N3+N3        | Variable     |
|  427  | ORIGIN_SUBDIVISION        | Country subdivision Of origin                                                                                                              | N3+X..3      | Variable     |
|  4300 | SHIP_TO_COMP              | Ship-to / Deliver-to company name                                                                                                          | N4+X..35     | Variable     |
|  4301 | SHIP_TO_NAME              | Ship-to / Deliver-to contact                                                                                                               | N4+X..35     | Variable     |
|  4302 | SHIP_TO_ADD1              | Ship-to / Deliver-to address line 1                                                                                                        | N4+X..70     | Variable     |
|  4303 | SHIP_TO_ADD2              | Ship-to / Deliver-to address line 2                                                                                                        | N4+X..70     | Variable     |
|  4304 | SHIP_TO_SUB               | Ship-to / Deliver-to suburb                                                                                                                | N4+X..70     | Variable     |
|  4305 | SHIP_TO_LOCALITY          | Ship-to / Deliver-to locality                                                                                                              | N4+X..70     | Variable     |
|  4306 | SHIP_TO_REG               | Ship-to / Deliver-to region                                                                                                                | N4+X..70     | Variable     |
|  4307 | SHIP_TO_COUNTRY           | Ship-to / Deliver-to country code                                                                                                          | N4+X2        | Variable     |
|  4308 | SHIP_TO_PHONE             | Ship-to / Deliver-to telephone number                                                                                                      | N4+X..30     | Variable     |
|  4310 | RTN_TO_COMP               | Return-to company name                                                                                                                     | N4+X..35     | Variable     |
|  4311 | RTN_TO_NAME               | Return-to contact                                                                                                                          | N4+X..35     | Variable     |
|  4312 | RTN_TO_ADD1               | Return-to address line 1                                                                                                                   | N4+X..70     | Variable     |
|  4313 | RTN_TO_ADD2               | Return-to address line 2                                                                                                                   | N4+X..70     | Variable     |
|  4314 | RTN_TO_SUB                | Return-to suburb                                                                                                                           | N4+X..70     | Variable     |
|  4315 | RTN_TO_LOCALITY           | Return-to locality                                                                                                                         | N4+X..70     | Variable     |
|  4316 | RTN_TO_REG                | Return-to region                                                                                                                           | N4+X..70     | Variable     |
|  4317 | RTN_TO_COUNTRY            | Return-to country code                                                                                                                     | N4+X2        | Variable     |
|  4318 | RTN_TO_POST               | Return-to postal code                                                                                                                      | N4+X..20     | Variable     |
|  4319 | RTN_TO_PHONE              | Return-to telephone number                                                                                                                 | N4+X..30     | Variable     |
|  4320 | SRV_DESCRIPTION           | Service code description                                                                                                                   | N4+X..35     | Variable     |
|  4321 | DANGEROUS_GOODS           | Dangerous goods flag                                                                                                                       | N4+N1        | Variable     |
|  4322 | AUTH_LEAV                 | Authority to leave                                                                                                                         | N4+N1        | Variable     |
|  4323 | SIG_REQUIRED              | Signature required flag                                                                                                                    | N4+N1        | Variable     |
|  4324 | NBEF_DEL_DT               | Not before delivery date time                                                                                                              | N4+N10       | Variable     |
|  4325 | NAFT_DEL_DT               | Not after delivery date time                                                                                                               | N4+N10       | Variable     |
|  4326 | REL_DATE                  | Release date                                                                                                                               | N4+N6        | Variable     |
|  7001 | NSN                       | NATO Stock Number (NSN)                                                                                                                    | N4+N13       | Variable     |
|  7002 | MEAT_CUT                  | UN/ECE meat carcasses and cuts classification                                                                                              | N4+X..30     | Variable     |
|  7003 | EXP_TIME                  | Expiration date and time                                                                                                                   | N4+N10       | Variable     |
|  7004 | ACTIVE_POTENCY            | Active potency                                                                                                                             | N4+N..4      | Variable     |
|  7005 | CATCH_AREA                | Catch area                                                                                                                                 | N4+X..12     | Variable     |
|  7006 | FIRST_FREEZE_DATE         | First freeze date                                                                                                                          | N4+N6        | Variable     |
|  7007 | HARVEST_DATE              | Harvest date                                                                                                                               | N4+N6..12    | Variable     |
|  7008 | AQUATIC_SPECIES           | Species for fishery purposes                                                                                                               | N4+X..3      | Variable     |
|  7009 | FISHING_GEAR_TYPE         | Fishing gear type                                                                                                                          | N4+X..10     | Variable     |
|  7010 | PROD_METHID               | Production method                                                                                                                          | N4+X..2      | Variable     |
|  7020 | REFURB_LOT                | Refurbishment lot ID                                                                                                                       | N4+X..20     | Variable     |
|  7021 | FUNC_STAT                 | Functional status                                                                                                                          | N4+X..20     | Variable     |
|  7022 | REV_STAT                  | Revision status                                                                                                                            | N4+X..20     | Variable     |
|  7023 | GIAI_ASSEMBLY             | Global Individual Asset Identifier (GIAI) of an assembly                                                                                   | N4+X..30     | Variable     |
|  703* | PROCESSOR_NUMBER          | Number of processor with ISO Country Code                                                                                                  | N4+N3+X..27  | Variable     |
|  7040 | UIC_EXT                   | GS1 UIC with Extension 1 and Importer index                                                                                                | N4+N1+X3     | Variable     |
|  710  | NHRN_PZN                  | National Healthcare Reimbursement Number (NHRN) - Germany PZN                                                                              | N3+X..20     | Variable     |
|  711  | NHRN_CIP                  | National Healthcare Reimbursement Number (NHRN) - France CIP                                                                               | N3+X..20     | Variable     |
|  712  | NHRN_CN                   | National Healthcare Reimbursement Number (NHRN) - Spain CN                                                                                 | N3+X..20     | Variable     |
|  713  | NHRN_DRN                  | National Healthcare Reimbursement Number (NHRN) - Brasil DRN                                                                               | N3+X..20     | Variable     |
|  714  | NHRN_AIM                  | National Healthcare Reimbursement Number (NHRN) - Portugal AIM                                                                             | N3+X..20     | Variable     |
|  723* | CERT_NUMBER               | Certification reference                                                                                                                    | N4+X2+X..28  | Variable     |
|  7240 | PROTOCOL                  | Protocol ID                                                                                                                                | N4+X..20     | Variable     |
|  8001 | DIMENSIONS                | Roll products (width, length, core diameter, direction, splices)                                                                           | N4+N14       | Variable     |
|  8002 | CMT_NUMBER                | Cellular mobile telephone identifier                                                                                                       | N4+X..20     | Variable     |
|  8003 | GRAI                      | Global Returnable Asset Identifier (GRAI)                                                                                                  | N4+N14+X..16 | Variable     |
|  8004 | GIAI                      | Global Individual Asset Identifier (GIAI)                                                                                                  | N4+X..30     | Variable     |
|  8005 | PRICE_PER_UNIT            | Price per unit of measure                                                                                                                  | N4+N6        | Variable     |
|  8006 | ITIP                      | Identification of an individual trade item piece (ITIP)                                                                                    | N4+N14+N2+N2 | Variable     |
|  8007 | IBAN                      | International Bank Account Number (IBAN)                                                                                                   | N4+X..34     | Variable     |
|  8008 | PROD_TIME                 | Date and time of production                                                                                                                | N4+N8+N..4   | Variable     |
|  8009 | OPTSEN                    | Optically Readable Sensor Indicator                                                                                                        | N4+X..50     | Variable     |
|  8010 | CPID                      | Component/Part Identifier (CPID)                                                                                                           | N4+Y..30     | Variable     |
|  8011 | CPID_SERIAL               | Component/Part Identifier serial number (CPID SERIAL)                                                                                      | N4+N..12     | Variable     |
|  8012 | VERSION                   | Software version                                                                                                                           | N4+X..20     | Variable     |
|  8013 | GMN                       | Global Model Number (GMN)                                                                                                                  | N4+X..25     | Variable     |
|  8017 | GSRN_PROVIDER             | Global Service Relation Number (GSRN) to identify the relationship between an organisation offering services and the provider of services  | N4+N18       | Variable     |
|  8018 | GSRN_RECIPIENT            | Global Service Relation Number (GSRN) to identify the relationship between an organisation offering services and the recipient of services | N4+N18       | Variable     |
|  8019 | SRIN                      | Service Relation Instance Number (SRIN)                                                                                                    | N4+N..10     | Variable     |
|  8020 | REF_NUMBER                | Payment slip reference number                                                                                                              | N4+X..25     | Variable     |
|  8026 | ITIP_CONTENT              | Identification of pieces of a trade item (ITIP) contained in a logistic unit                                                               | N4+N14+N2+N2 | Variable     |
|  8110 | COUPON_USA                | Coupon code identification for use in North America                                                                                        | N4+X..70     | Variable     |
|  8111 | POINTS                    | Loyalty points of a coupon                                                                                                                 | N4+N4        | Variable     |
|  8121 | POSITIVE_OFFER_COUPON_USA | Paperless coupon code identification for use in North America                                                                              | N4+X..70     | Variable     |
|  8200 | PRODUCT_URL               | Extended Packaging URL                                                                                                                     | N4+X..70     | Variable     |
|  90   | AGREEMENT_INTERNAL        | Information mutually agreed between trading partners                                                                                       | N2+X..30     | Variable     |
|  91   | COMPANY_INTERNAL_1        | Company internal information                                                                                                               | N2+X..90     | Variable     |
|  92   | COMPANY_INTERNAL_2        | Company internal information                                                                                                               | N2+X..90     | Variable     |
|  93   | COMPANY_INTERNAL_3        | Company internal information                                                                                                               | N2+X..90     | Variable     |
|  94   | COMPANY_INTERNAL_4        | Company internal information                                                                                                               | N2+X..90     | Variable     |
|  95   | COMPANY_INTERNAL_5        | Company internal information                                                                                                               | N2+X..90     | Variable     |
|  96   | COMPANY_INTERNAL_6        | Company internal information                                                                                                               | N2+X..90     | Variable     |
|  97   | COMPANY_INTERNAL_7        | Company internal information                                                                                                               | N2+X..90     | Variable     |
|  98   | COMPANY_INTERNAL_8        | Company internal information                                                                                                               | N2+X..90     | Variable     |
|  99   | COMPANY_INTERNAL_9        | Company internal information                                                                                                               | N2+X..90     | Variable     |
