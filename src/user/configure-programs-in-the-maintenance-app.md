...
| **Custom label for enrollment date** |Defines the meaning of the enrollment date in this program, tipically representing when the date when the tracked entity is enrolled into the program.|
