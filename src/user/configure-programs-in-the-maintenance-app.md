...
| d2:round | (number [, decimals]) | Rounds the input argument to the nearest integer. An optional second argument can be provided to specify the decimal precision of the result. <br>Example: d2:round(1.25, 1) = 1.3 |
