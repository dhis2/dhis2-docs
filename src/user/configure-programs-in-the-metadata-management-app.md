...
| d2:exponent | (base, exponent) | Raises the first argument to the power of the second argument. Requires the new rule engine, available in the Capture app from DHIS2 2.42 onward; not supported by the legacy rule engine used on earlier versions. <br>Example, taking the square root of 49:<br> `d2:exponent(49, 0.5)` |
...
| d2:log | (number [, base]) | Produces the natural logarithm of the argument number. If a second argument is given, produces the logarithm of the first argument to that base instead. Requires the new rule engine, available in the Capture app from DHIS2 2.42 onward; not supported by the legacy rule engine used on earlier versions. <br>Example, the logarithm of 8 to base 2:<br> `d2:log(8, 2)` |
