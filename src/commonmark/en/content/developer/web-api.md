...
curl like this:
    ...
    curl "play.dhis2.org/demo/api/32/systemSettings/my-key" -d "My long value"
      -H "Content-Type: text/plain" -u admin:district -v
...
query parameter:
    ...
    curl "play.dhis2.org/demo/api/32/systemSettings?key=keyApplicationNotification&key=keyApplicationIntro"
      -u admin:district -v

You can retrieve all system settings with a GET request:

    /api/32/systemSettings
