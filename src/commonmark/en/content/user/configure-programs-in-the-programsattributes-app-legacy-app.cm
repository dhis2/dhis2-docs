...
4.  Enter program stage details:
    ...
    3.  In the **Scheduled days from start** field, enter the minimum
...
![](resources/images/program/program_notification_ui.png)

1.  Open the **Program / Attributes** app and click **Program**.

2.  Click the relevant program and select **View program
    notifications**.
...
5.  In the **Trigger by** field, select what should trigger the
    notification.
...
3.  Click the relevant program stage and select **View program stage
    notifications**.
...
6.  In the **Trigger by** field, select what should trigger the
    notification.
...
7.  In the **Recipients** field, select who should receive the program
